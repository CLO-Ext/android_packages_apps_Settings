...
public class SwipeToScreenshotPreferenceController extends GesturePreferenceController
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        mPreference = (SystemSettingMainSwitchPreference) screen.findPreference(THREE_FINGER_GESTURE);
    ...
    private class SettingObserver extends ContentObserver {
        private final Uri mUri = Settings.System.getUriFor(THREE_FINGER_GESTURE);
