/*
 * Copyright (C) 2019 Project Zephyrus
 *
...
public class VolumeButtonMusicControlPreferenceController extends GesturePreferenceController
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        mPreference = (SystemSettingMainSwitchPreference) screen.findPreference(VOLBTN_MUSIC_CONTROLS);
    ...
    private class SettingObserver extends ContentObserver {
        private final Uri mUri = Settings.System.getUriFor(VOLBTN_MUSIC_CONTROLS);
