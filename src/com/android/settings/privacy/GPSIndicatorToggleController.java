 ...
 */
public class GPSIndicatorToggleController
        extends TogglePreferenceController implements LifecycleObserver {

    private static final String KEY_GPS = "location_privacy_indicator_enabled";
    ...
    public GPSIndicatorToggleController(Context context) {
        super(context, KEY_GPS);
        updateConfig();
    }
    ...
    public boolean isChecked() {
        return Settings.Secure.getInt(mContext.getContentResolver(),
                Settings.Secure.LOCATION_PRIVACY_INDICATOR_ENABLED, (mDefault ? 1 : 0)) != 0;
    }

    @Override
    public boolean setChecked(boolean isChecked) {
        Settings.Secure.putInt(mContext.getContentResolver(),
                Settings.Secure.LOCATION_PRIVACY_INDICATOR_ENABLED, (isChecked ? 1 : 0));
